    ...
    create table Item (
        ...
        colour varchar(255) check (colour in ('RED','BLUE','GREEN','YELLOW','WHITE','BLACK','GREY')),
        name varchar(255),
...
INSERT INTO Item (id, name, value, colour, onStock, brand, size, category, size) VALUES (31, 'Sport Runners', 79.99, 'BLACK', true, 'NIKE', '42', 'shoe', 42),        (32, 'Classic Sneakers', 69.99, 'WHITE', true, 'ADIDAS', '43', 'shoe', 43),        (33, 'Casual Loafers', 89.99, 'BROWN', false, 'LACOSTE', '41', 'shoe', 41),        (34, 'High Top Sneakers', 99.99, 'BLUE', true, 'TOMMY_HILFIGER', '44', 'shoe', 44),        (35, 'Gym Trainers', 74.99, 'BLACK', true, 'PUMA', '45', 'shoe', 45),        (36, 'Leather Boots', 129.99, 'BLACK', false, 'TRUSSARDI', '42', 'shoe', 42),        (37, 'Slip Ons', 59.99, 'GREY', true, 'BASIC', '43', 'shoe', 43),        (38, 'Street Style Shoes', 84.99, 'RED', false, 'NIKE', '44', 'shoe', 44),        (39, 'Hiking Boots', 139.99, 'GREEN', true, 'ADIDAS', '45', 'shoe', 45),        (40, 'Formal Oxfords', 114.99, 'BLACK', false, 'LACOSTE', '42', 'shoe', 42);
